            ...
            <ul id="accordion-menu">
                ...
                <li>
                    <a href="sitemap.html" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-envelope-paper"></span><span class="mtext">Assistance</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="<?= base_url() ?>generatereportcontroller/report" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-printer"></span><span class="mtext">Generate Report</span>
                    </a>
                </li>
