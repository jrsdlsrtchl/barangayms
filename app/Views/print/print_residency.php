...
<body>
    ...
    <div class="certification">
        ...
        <div class="content">
            ...
            <p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; THIS IS TO CERTIFY that <b><u><?= strtoupper($request['0']->firstname) . " " . substr($request['0']->middlename, 0, 1) . ". " . strtoupper($request['0']->lastname)  ?>,&nbsp; <?= $request['0']->age ?></u></b> years of age a Filipino
    ...
    <div class="footer-wrap pd-20 mb-20 card-box copyright">
        <div>Printed By: Pedro Penduko</div>
