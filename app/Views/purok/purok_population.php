        ...
        <div class="min-height-200px">
            ...
            <div class="page-header">
                <div class="row">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">
                                    <a href="<?= base_url() ?>purokcontroller/purok"> Purok Table</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php if (!empty($purok)) { ?>
                                        Purok <?= $purok['0']->purok_id; ?> Table
                                    <?php } ?>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <a class="btn btn-primary d-none d-md-inline" href="<?= base_url() ?>purokcontroller/purok" role="button">
                            Back
                        </a>
                    </div>
                </div>
            ...
            <div class="card-box mb-30">
                <div class="card-header">
                    <?php if (!empty($purok)) { ?>
                        <h4 class="text-blue mt-2 h4">Purok <?= $purok['0']->purok_id; ?> Information Table</h4>
                    <?php } ?>
                </div>
